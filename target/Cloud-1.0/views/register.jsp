	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41"> Đăng ký tài khoản </span>
				<form class="login100-form validate-form p-b-33 p-t-5"
					action="<c:url value="/register"/>" method="POST">
					<c:if test="${mess == 1}">
					<p class="text-danger text-center">Xác nhận mậu khẩu không trùng với mật khẩu</p>
					</c:if>
					<c:if test="${mess == 2}">
					<p class="text-danger text-center">Tên tài khoản đã có người sử dụng</p>
					</c:if>
