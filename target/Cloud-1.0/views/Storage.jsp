		...
		<div class="page-wrapper">
			...
			<div class="page-breadcrumb bg-white">
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Thông tin các tệp và thư mục được lưu trữu trên Server ${server}</h4>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							<h3 class="box-title">Để truy cập dữ liệu được lưu trữu sử dụng lệnh: cd /user${id}. Trên các Container Server ${server} </h3>
