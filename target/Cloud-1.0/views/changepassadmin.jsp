	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
		...
		<div class="page-wrapper">
			...
			<div class="col-lg-8 col-xlg-9 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material"action="<c:url value="/changepassad?Id=${Id}"/>" method="POST">
                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0">Mật khẩu mới</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" placeholder="Nhập mậu khẩu" class="form-control p-0 border-0" name="pass"> </div>
                                </div>
                                <div class="form-group mb-4">
                                    <div class="col-sm-12">
